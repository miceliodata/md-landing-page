...
<template>
    <div class="p-6 bg-mid rounded-md shadow-lg hover:-translate-y-1 transition">
        ...
        <h2 class="text-2xl text-center font-semibold text-gray-200">Tier {{ props.tier }}</h2>
        <h3 class="text-lg text-center font-light text-gray-200 mb-2">{{ props.title }}</h3>
        <h4 class="text-center text-gray-200 mt-4 mb-6">{{ props.subtitle }}</h4>
        <div 
