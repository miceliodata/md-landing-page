...
<template>
      <div class="flex flex-col h-full rounded-md shadow-lg p-2">
        ...
        <div class="flex-1 space-y-4">
          ...
          <h4 class="text-gray-700 text-md font-medium">
        ...
        <a :href="address" class="pt-12 pb-4 flex items-center justify-center text-black font-medium group space-x-2">
          <div :class="`${iconBGColor} flex items-center py-2 px-4 rounded-3xl`">
