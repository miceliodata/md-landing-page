...
// Remove duplicate animations - using global composable instead
</script>
...
<template>
  ...
  >
    <h1
      class="text-4xl md:mr-[50%] md:text-5xl font-bold text-gray-100 mb-16 md:ml-16 lg:ml-20 animate-slide-left"
    >
      MicelioData is the gateway to connectivity
    </h1>
